...
- The installation and runcom setup is
  [tested weekly on real Ubuntu and macOS machines](https://github.com/alexzhaohong/dotfiles/actions)
...
```bash
bash -c "`curl -fsSL https://raw.githubusercontent.com/alexzhaohong/dotfiles/master/remote-install.sh`"
```
...
```bash
git clone https://github.com/alexzhaohong/dotfiles.git ~/.dotfiles
```
...
[GitHub Action](https://github.com/alexzhaohong/dotfiles/actions).
